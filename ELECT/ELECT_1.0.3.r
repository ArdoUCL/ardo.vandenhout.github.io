...
# Ardo van den Hout, Cambridge 2010 - UCL 2017. 
# Including code written by Mei Sum Chan 
...
################################################
# ELECT function:
elect <- function(model, b.covariates, statedistdata, 
...
plusmin.elect <- function(LEs,index=NA,func="plus",
